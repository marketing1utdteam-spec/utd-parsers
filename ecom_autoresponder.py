...
"STUDIES you may cite (real and named; use AT MOST ONE per reply, and only when it genuinely fits their pain; never cite any other statistic): Google/SOASTA 2017: the probability of a bounce grows 32% as mobile page load goes from 1s to 3s. Deloitte and Google 'Milliseconds Make Millions' 2020: a 0.1s speed improvement lifted retail conversions by about 8.4%. Portent 2022: sites that load in 1s convert about 2.5x better than sites that load in 5s. Baymard Institute: about 70% of online shopping carts are abandoned.\n\n"
