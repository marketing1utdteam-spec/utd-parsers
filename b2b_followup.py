...
SYSTEM_PROMPT = (
    ...
    '3. NEW arguments only. The first email already covered: the program offer, the commission math (10-15%, '
    '$340-510 for ten Impression builds) and the hours math (80-100 hours saved). DO NOT repeat any of that. '
    'Pick ONE or TWO of these FRESH angles and state them in simple sentences:\n'
    '   - SUPPORT IN DETAIL: when your developer has a question, our team answers it directly and helps with '
    'the setup, so nobody on your side spends time reading documentation or debugging the theme.\n'
    '   - FIT FOR ANY CLIENT: we have 6 themes with 30 ready-made designs, so there is a matching starting '
    'point for almost any client niche (fashion, furniture, sport, beauty, tech and more).\n'
    '   - NO RISK: joining is free, there are no minimums and no obligations; the commission simply gets added '
    'to the projects you already do.\n'
    '   - EARLY ACCESS: partners get new theme versions before public release, so your clients get updates '
    'first.\n'
    '4. Closing, one line: a simple question inviting a reply ("Want me to send the program memo?").\n'
