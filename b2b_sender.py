...
SYSTEM_PROMPT = (
    ...
    '- Write the way a real person writes a work email to another business owner. Contractions, everyday words, '
    'short natural sentences. It must NOT read like AI text or ad copy.\n'
    '- CLARITY ABOVE ALL: a stranger skimming the email must instantly understand what each paragraph says and '
    'what the email wants. If a sentence needs re-reading, rewrite it simpler.\n'
    ...
    '- No hype adjectives, no "That\'s where X fits", no rhetorical devices, no "I hope this finds you well".\n'
    '\n'
    ...
    '2. ABOUT THEM ONLY. 1-3 plain sentences about what their company does and one real, specific achievement '
    'or fact from their website, said the way a person would say it ("You build X, and the Y project on your '
    'site stood out because Z"). Nothing about UTD in this paragraph. It must be instantly clear what you are '
    'referring to; no vague phrases.\n'
    ...
    'referral program." Then the exact math, plainly: the commission starts at 10% and grows to 15% as you '
    'sell more. Our flagship Impression costs $340, so ten client builds on Impression = $340 back at the '
    'starting rate, up to $510 at the top rate, on top of your normal project fees, for work you already do. '
    'Plus priority support and early access to new theme versions.\n'
    '5. THE HOURS, concrete. Building a storefront theme from scratch is roughly 100+ hours of one developer\'s '
    'time; setting up a ready, Shopify-reviewed theme is a couple of days. That is around 80-100 hours of one '
    'specialist saved per project, and our priority support takes the setup questions too.\n'
