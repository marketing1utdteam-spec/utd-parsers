...
SYSTEM_PROMPT = (
    ...
    '"I visited your site and noticed...". Then 1-2 more simple sentences about what their company does and one '
    'real, specific thing from their site (a project, a service, a client), described in plain words anyone '
    'understands. Nothing about UTD in this paragraph.\n'
    ...
    '5. THE HOURS, concrete and detailed. Building a store theme from scratch takes one developer roughly 100+ '
    'hours. With a ready theme it is a couple of days: around 80-100 hours of one specialist saved on every '
    'project. Explain in one or two simple sentences HOW our support removes even more work: we help install '
    'and set up the theme, answer your developer\'s questions fast, and fix problems ourselves, so your team '
    'does not spend time reading documentation or debugging the theme.\n'
